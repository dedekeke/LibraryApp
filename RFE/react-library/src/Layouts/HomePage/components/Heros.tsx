          ...
          <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
            <div className="ml-2">
              ...
              {authState?.isAuthenticated ? (
                <Link to="search" type="button" className="btn main-color text-white btn-lg">
                  Explore top books
                </Link>
              ) : (
          ...
          <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
            <div className="ml-2">
              ...
              <p className="lead">
                ...
                provide the most accurate book selection possible for our students! We are diligent
